...
/**
 * Failed when compile 'com.jmedeisis:draglinearlayout:1.1.0' at gradle
 * So copy https://github.com/justasm/DragLinearLayout into library
 */
...
public class DragLinearLayout extends LinearLayout {
    ...
    /**
     * Use with setOnViewSwapListener(OnViewSwapListener)
    ...
    public interface OnViewSwapListener {
        ...
        /**
         * @return false if can not drag above or below this position
         */
        boolean canSwap(View firstView, int firstPosition, View secondView, int secondPosition);
    ...
    /**
     * The currently dragged item, if DragItem#detecting.
     */
    ...
    private void onDrag(final int offset) {
        ...
        if (isBelow || isAbove) {
            ...
            if (null != swapListener) {
                if (!swapListener.canSwap(draggedItem.view, draggedItem.position, switchView, switchPosition)) {
                    return;
                }
